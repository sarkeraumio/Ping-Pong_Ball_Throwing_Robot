...
void setup() 
{
  ...
  PS4.begin("08:f0:9e:50:57:0a ");  //set the six axis mac address by our own. Please make sure the mac address is unique and the last bit of the first byte must be zero. https://www.rapidtables.com/convert/number/hex-to-binary.html
